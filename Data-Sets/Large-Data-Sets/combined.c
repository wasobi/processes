//
//  rotate
//  Reads an image file (in TGA format), and saves a rotated version of the
//	image
//
//  Created by Jean-Yves HERVE on 2020-10-10.
//
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
...
char getHeaderInfoPPM_PGM_(FILE* inPPM, char* filePath,
 ...
 */
ImageStruct readPPM_PGM(char* filePath);
 ...
 */
ImageIOErrorCode writePPM_PGM(char* filePath, ImageStruct* img);
 ...
 *  @return  a properly initialized ImageStruct storing the image read
 */
ImageStruct readTGA(char* filePath);
 ...
 */
ImageIOErrorCode determineRotation(char* rotStr, RotationVal* rotVal);
 ...
 */
void errorReport(ImageIOErrorCode code, char* input);
 ...
 */
ImageStruct copyImage(ImageStruct* image);
 ...
 */
ImageStruct rotateImage90(ImageStruct* image);
 ...
 *  @return a new image struct that stores the rotated image
 */
ImageStruct rotateImage180(ImageStruct* image);
 ...
 *  @return a new image struct that stores the rotated image
 */
ImageStruct rotateImage270(ImageStruct* image);
